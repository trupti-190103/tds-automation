...
def process_contractor_1024_tds(uploaded_file):
    ...
    ws['A2'] = 'TDS on Contractor ( Other Than Individual)1024 Code'
    ...
    for index, row in df.iterrows():
        ...
        ws.cell(excel_row, 3).value = (
            'Contractor is a person other than an individual'
        )

        # CODE
        ws.cell(excel_row, 4).value = '1024'
        ...
        # PERCENT
        ws.cell(excel_row, 11).value = 0.02
