...
def process_professional_tds(uploaded_file):
    ...
    for index, row in df.iterrows():
        ...
        ws.cell(excel_row, 3).value = (
            'Any of fees for professional'
        )

        # CODE
        ws.cell(excel_row, 4).value = '1027'

        # OLD SECTION
        ws.cell(excel_row, 5).value = '194J'
        ...
        # PERCENT
        ws.cell(excel_row, 11).value = 0.10
